            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className="text-center mb-16 space-y-4">
                    ...
                    <h2 className="font-display text-4xl md:text-5xl font-bold text-white leading-tight">
                        {t('faq.title')} <span className="text-transparent bg-clip-text bg-linear-to-r from-[#D4A84B] via-[#F0D080] to-[#C5943A]">Dúvidas</span>
                    </h2>
                ...
                >
                    ...
                    <div className="relative flex flex-col items-center gap-6 px-8 py-12 text-center">
                        ...
                        >
                            ...
                            <span className="relative">{t('faq.cta_button')}</span>
                        </a>
