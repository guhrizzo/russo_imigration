...
const services = [
  {
    ...
    title: 'Taxa Anual de Asilo',
    badge: 'Destaque',
    description:
      'Assessoria completa para o processo de asilo nos EUA. Cuidamos de toda a documentação, prazos e estratégias para maximizar suas chances de aprovação.',
    features: ['Análise do caso', 'Preparação de documentos', 'Acompanhamento de audiências', 'Suporte contínuo'],
  },
  {
    icon: <Scale size={28} />,
    title: 'Defesa em Imigração',
    badge: null,
    description:
      'Representação estratégica para processos de imigração, incluindo defesa contra deportação e regularização de status.',
    features: ['Defesa contra deportação', 'Regularização de status', 'Recursos administrativos'],
  },
  {
    icon: <Globe size={28} />,
    title: 'Vistos & Green Card',
    badge: null,
    description:
      'Orientação especializada para pedidos de vistos de trabalho, família e residência permanente nos Estados Unidos.',
    features: ['Visto de trabalho', 'Reunificação familiar', 'Residência permanente'],
  },
  {
    icon: <ShieldCheck size={28} />,
    title: 'Proteção & Sigilo',
    badge: null,
    description:
      'Todas as suas informações são tratadas com absoluta confidencialidade. Sua privacidade é nossa prioridade em cada etapa do processo.',
    features: ['100% confidencial', 'Dados protegidos', 'Comunicação segura'],
  },
  {
    icon: <Clock size={28} />,
    ...
    badge: null,
    description:
      'Processos organizados e equipe dedicada para que seu caso avance com a máxima agilidade dentro dos prazos legais.',
    features: ['Gestão de prazos', 'Processo organizado', 'Atualizações regulares'],
  },
  {
    icon: <Users2 size={28} />,
    ...
    badge: null,
    description:
      'Cada caso é único. Nossa equipe ouve, entende e cuida de você com empatia, desenvolvendo a melhor estratégia para a sua situação.',
    features: ['Consulta individual', 'Estratégia personalizada', 'Acompanhamento próximo'],
  },
]
    ...
    <section id="servicos" ref={sectionRef} className="relative py-28 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="animate-on-scroll text-center mb-20">
          <p className="text-gold-400 text-xs tracking-[0.3em] uppercase font-medium mb-4">O Que Fazemos</p>
          ...
          <p className="max-w-xl mx-auto text-white/60 leading-relaxed font-light">
            Oferecemos assessoria completa em imigração, com estratégias eficazes e atendimento humanizado para cada etapa da sua jornada.
          </p>
        </div>
        ...
        <div className="animate-on-scroll mt-16 relative rounded-3xl overflow-hidden p-10 text-center"
          ...
          <p className="text-gold-400 text-xs tracking-[0.3em] uppercase mb-4">Pronto para começar?</p>
          ...
          <p className="text-white/60 mb-8 max-w-lg mx-auto font-light">
            Entre em contato hoje e descubra como podemos ajudar você a construir um novo futuro nos Estados Unidos.
          </p>
           <a
