    ...
    <footer className="relative bg-navy-950 border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          {/* Links */}
          <div>
            <h4 className="text-white/60 text-xs uppercase tracking-widest mb-5">{t('footer.navigation')}</h4>
          ...
          {/* CTA */}
          <div>
            <h4 className="text-white/60 text-xs uppercase tracking-widest mb-5">{t('footer.speak_with_us')}</h4>
