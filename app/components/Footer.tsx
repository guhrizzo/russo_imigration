      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-white/40 text-sm leading-relaxed mb-5">
              Novos Começos. Futuros Extraordinários.<br />
              Assessoria especializada em imigração nos EUA.
            </p>
            <p className="text-gold-400/60 text-xs italic font-display">
          ...
          {/* Links */}
          <div>
            <h4 className="text-white/60 text-xs uppercase tracking-widest mb-5">Navegação</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <a href={link.href} className="text-white/50 hover:text-gold-400 text-sm transition-colors">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          {/* CTA */}
          <div>
            <h4 className="text-white/60 text-xs uppercase tracking-widest mb-5">Fale Conosco</h4>
            <p className="text-white/50 text-sm leading-relaxed mb-6">
              Pronto para dar o primeiro passo? Nossa equipe está disponível para orientar você.
            </p>
            <a
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/30 text-xs">
            © {year} Russo Immigration llc. Todos os direitos reservados.
          </p>
